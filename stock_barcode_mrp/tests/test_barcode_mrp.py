...
from odoo.addons.stock_barcode.tests.test_barcode_client_action import TestBarcodeClientAction, clean_access_rights
...
class TestPickingBarcodeClientAction(TestBarcodeClientAction):
    ...
    def test_immediate_receipt_kit_from_scratch_with_tracked_compo(self):
        self._receipt_kit_from_scratch_with_tracked_compo(True)

    def test_planned_receipt_kit_from_scratch_with_tracked_compo(self):
        self._receipt_kit_from_scratch_with_tracked_compo(False)

    def _receipt_kit_from_scratch_with_tracked_compo(self, immediate):
        ...
        self.start_tour(url, 'test_receipt_kit_from_scratch_with_tracked_compo', login='admin', timeout=180)

        self.assertRecordValues(receipt_picking.move_lines.move_line_ids, [
